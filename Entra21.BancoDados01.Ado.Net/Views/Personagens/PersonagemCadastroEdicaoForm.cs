...
namespace Entra21.BancoDados01.Ado.Net.Views.Personagens
{
    public partial class PersonagemCadastroEdicaoForm : Form
    {
        ...
        public PersonagemCadastroEdicaoForm(Personagem personagem) : this()
        {
            ...
            //Percorrer cada um dos itens do tipo personagem, para selecionar o que o usuario tinha cadastrado anteriormente
        ...
        private void buttonSalvar_Click(object sender, EventArgs e)
        {
            ...
            if (_idParaEditar == -1)
            {
                ...
                MessageBox.Show("Personagens cadastrado com sucesso");
                Close();
            }
            else
            {
