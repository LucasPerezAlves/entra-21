...
namespace Entra21.BancoDados01.Ado.Net.Service
{
    internal class PersonagemService : IpersonagemService
    {
        public void Apagar(int id)
        {
            ...
            //Substituit os @ no comando da QUERY que será executada no banco de dados,
...
INNER JOIN editoras AS e ON(p.id_editora = e.id)";
            ...
            for(int i = 0; i < tabelaEmMemoria.Rows.Count; i++)
            {
                ...
                //Instanciar a editora para poder armaenar o da editora
                personagem.Editora = new Editora();
                ...
                personagem.TipoPersonagem.Id = Convert.ToInt32(registro
                    ["tipo_personagem_id"]);
                personagem.TipoPersonagem.Tipo = registro
                    ["tipo_personagem_tipo"].ToString();
